odoo.define('tkn_redeemable_products_in_pos.RedeemableProductsWidgetControlPanel', function(require) {
    'use strict';
    ...
    class RedeemableProductsWidgetControlPanel extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    RedeemableProductsWidgetControlPanel.template = 'RedeemableProductsWidgetControlPanel';

    Registries.Component.add(RedeemableProductsWidgetControlPanel);

    return RedeemableProductsWidgetControlPanel;
});
