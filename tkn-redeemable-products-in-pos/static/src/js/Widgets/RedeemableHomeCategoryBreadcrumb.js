odoo.define('tkn_redeemable_products_in_pos.RedeemableHomeCategoryBreadcrumb', function(require) {
    'use strict';
    ...
    class RedeemableHomeCategoryBreadcrumb extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        async _categPopup() {
            ...
            if (confirmed) {
                this.trigger('switch-category-id', selectedCategory.id);
            }
        }
    }
    RedeemableHomeCategoryBreadcrumb.template = 'RedeemableHomeCategoryBreadcrumb';

    Registries.Component.add(RedeemableHomeCategoryBreadcrumb);

    return RedeemableHomeCategoryBreadcrumb;
});
